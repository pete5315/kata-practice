// https://www.codewars.com/kata/5a91a7c5fd8c061367000002/train/typescript
...
export function minimumSteps(nums: number[], value: number) {
  // your code here
  nums.sort((a,b) => a-b);
  let sumTracker: number = nums[0];
  let count = 0;
  while (sumTracker<value) {
    count++
    console.log(sumTracker, nums[count])
    sumTracker = sumTracker + nums[count];
  }
  return count;
}

console.log(minimumSteps([1,2,3,6,10,12],6))